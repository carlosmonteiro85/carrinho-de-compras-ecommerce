...
public class CheckoutServiceTest extends GameStoreApplicationTests {
...
//	@Test
	...
	public void insertCheckoutWithFrete() {
		...
		product1.setScore(faker.random().nextInt(0, 1000));
		...
		product2.setScore(faker.random().nextInt(0, 1000));
